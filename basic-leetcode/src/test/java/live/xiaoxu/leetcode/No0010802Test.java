...
class No0010802Test {
    ...
    private static No001080_2.TreeNode toNode(Integer[] array) {

        int index = 0;
        No001080_2.TreeNode treeNode = new No001080_2.TreeNode(array[index]);
        LinkedList<No001080_2.TreeNode> linkedList = new LinkedList<>();
        linkedList.add(treeNode);
        while (index < array.length && linkedList.size() != 0) {

            No001080_2.TreeNode node = linkedList.poll();
            if (node == null) {
                continue;
            }
            node.val = array[index];
            node.left = new No001080_2.TreeNode();
            linkedList.add(node.left);
            node.right = new No001080_2.TreeNode();
     ...
     */
    private static boolean cleanEmptyNode(No001080_2.TreeNode treeNode) {
    ...
    private static Integer[] toArray(No001080_2.TreeNode treeNode) {

        List<No001080_2.TreeNode> list = toList(treeNode);
        List<Integer> integerList = new ArrayList<>();
        for (No001080_2.TreeNode node : list) {
            if (node == null) {
    ...
    private static List<No001080_2.TreeNode> toList(No001080_2.TreeNode treeNode) {

        LinkedList<No001080_2.TreeNode> list = new LinkedList<>();
        list.add(treeNode);
        return toList(list);
    }
     ...
     * @return 铺平后的集合
     */
    private static List<No001080_2.TreeNode> toList(LinkedList<No001080_2.TreeNode> treeNodeList) {
        ...
        LinkedList<No001080_2.TreeNode> nextLevelList = new LinkedList<>();
        boolean noData = true;
        for (No001080_2.TreeNode treeNode : treeNodeList) {
            list.add(treeNode);
            if (treeNode == null) {
    ...
    void sufficientSubset() {
        ...
        No001080_2.TreeNode node12 = toNode(new Integer[]{5, 4, 8, 11, null, 17, 4, 7, 1, null, null, 5, 3});
        No001080_2.TreeNode node1 = toNode(new Integer[]{1, 2, 3, 4, -99});
        No001080_2.TreeNode node11 = toNode(new Integer[]{1, 2, 3});
        No001080_2.TreeNode node = toNode(new Integer[]{1, -99});
        No001080_2.TreeNode node2 = toNode(new Integer[]{1, 2, 3, 4, -99, -99, 7, 8, 9, -99, -99, 12, 13, -99, 14});
